    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-mini"><b>SC</b>F</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>SISCOMF</b></span>
        </a>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs">CajuWeb</span>
                </a>
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                      CajuWeb- Desenvolvimento de Sistemas
                      <small>www.cajuwebdesenvolvimento.com</small>
                    </p>
                  </li>
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2015-2020 <a href="www.cajuwebdesenvolvimento.com.br">CajuWeb</a>.</strong> Todos os direitos reservados.
      </footer>
